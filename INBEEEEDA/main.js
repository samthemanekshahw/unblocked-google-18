...
*/
        ...
        this.ammoText.setPosition(SCREEN_WIDTH - 20,SCREEN_HEIGHT - 20);
        this.ammoText.SetText("= " + "9999");        BulletSp.position.set(SCREEN_WIDTH - 100, SCREEN_HEIGHT - 20);
...
init: function(STAGELEVEL) {
        ...
        this.ResultText2.SetText("で侵略成功した");
        ...
        url = "cachacacha.com/HIMA/INBEEEEDA/";
        txt = encodeURIComponent("Stage"+ STAGELEVEL + "で侵略成功した  " + url + "   #インベーダーのきもち");
       ...
       //switch(24){
            ...
            case 1:
               // enemy = Enemy("KaitenRakkaMove").addChildTo(EnemyGroup);
                ...
                Enemy(this.EnemyPositionCenter,"OuhukuRakka","EnemyGreenSS",this.EnemySpeed,"hsla({0}, 100%, 50%, 1)".format("129"),ParticleGroup1).addChildTo(EnemyGroup);
            ...
            case 3:
                this.EnemySpeed = 5;
                this.Player.ammo  =1;
                Enemy(this.EnemyPositionCenter,"OuhukuRakka","EnemyRedSS",this.EnemySpeed,"hsla({0}, 100%, 50%, 1)".format("0"),ParticleGroup3).addChildTo(EnemyGroup);    
            ...
            case 4:
                this.EnemySpeed = 6;
                this.Player.ammo  =1;
                Enemy(this.EnemyPositionCenter,"OuhukuRakka","EnemyGreen2SS",this.EnemySpeed,"hsla({0}, 100%, 50%, 1)".format("129"),ParticleGroup1).addChildTo(EnemyGroup);
            ...
            case 5:
                this.EnemySpeed = 6;
                this.Player.ammo  =1;
                Enemy(this.EnemyPositionCenter,"OuhukuRakka","EnemyBlue2SS",this.EnemySpeed,"hsla({0}, 100%, 50%, 1)".format("237"),ParticleGroup2).addChildTo(EnemyGroup);    
            ...
            case 6:
                this.EnemySpeed = 7;
                this.Player.ammo  =1;
                Enemy(this.EnemyPositionRight,"OuhukuRakka","EnemyRed2SS",this.EnemySpeed,"hsla({0}, 100%, 50%, 1)".format("0"),ParticleGroup3).addChildTo(EnemyGroup);    
            ...
            case 8:
                this.EnemySpeed = 7;
                Enemy(this.EnemyPositionLeft,"OuhukuRakka","EnemyGreenSS",this.EnemySpeed,"hsla({0}, 100%, 50%, 1)".format("129"),ParticleGroup1).addChildTo(EnemyGroup);
            ...
            case 10:
                this.EnemySpeed = 8;
                Enemy(this.EnemyPositionLeft,"OuhukuRakka","EnemyRedSS",this.EnemySpeed,"hsla({0}, 100%, 50%, 1)".format("0"),ParticleGroup1).addChildTo(EnemyGroup);    
            ...
            case 12:
                ...
                this.EnemySpeed = 8;
                Enemy(this.EnemyPositionRight,"OuhukuRakka","EnemyRed2SS",this.EnemySpeed,"hsla({0}, 100%, 50%, 1)".format("0"),ParticleGroup1).addChildTo(EnemyGroup);     
            ...
            case 14:
                ...
                this.EnemySpeed = 8;
                Enemy(this.EnemyPositionCenter,"OuhukuRakka","EnemyRed2SS",this.EnemySpeed,"hsla({0}, 100%, 50%, 1)".format("0"),ParticleGroup1).addChildTo(EnemyGroup);     
                this.Player.ammo  =2;
            ...
            case 15:
                ...
                this.EnemySpeed = 9;
                Enemy(this.EnemyPositionCenter,"OuhukuRakka","EnemyBlue2SS",this.EnemySpeed,"hsla({0}, 100%, 50%, 1)".format("237"),ParticleGroup1).addChildTo(EnemyGroup);  
                this.Player.ammo  =2;
            break;
            ...
            break;    
             ...
             case 24:
                ...
                this.EnemySpeed = 11;
                Enemy(this.EnemyPositionCenter,"OuhukuRakka","EnemyRedSS",this.EnemySpeed,"hsla({0}, 100%, 50%, 1)".format("0"),ParticleGroup1).addChildTo(EnemyGroup);    
               this.Player.ammo  =3;
            ...
            break;    
             ...
             case 26:
                ...
                this.EnemySpeed = 11;
                Enemy(this.EnemyPositionLeft,"OuhukuRakka","EnemyBlue2SS",this.EnemySpeed,"hsla({0}, 100%, 50%, 1)".format("237"),ParticleGroup1).addChildTo(EnemyGroup);  
                this.Player.ammo  =3;
            ...
            case 28:
                ...
                this.EnemySpeed = 10;
                Enemy(this.EnemyPositionLeft,"OuhukuRakka","EnemyGreen2SS",this.EnemySpeed,"hsla({0}, 100%, 50%, 1)".format("129"),ParticleGroup1).addChildTo(EnemyGroup);
               this.Player.ammo  =3;
...
init: function() {
    ...
    update: function(app) {
       ...
       if(this.PlayFLG){
        ...
        if(this.ShotTimer > this.ShotRemit){
            this.Shot();
            this.ShotTimer = 0;
    ...
    Shot: function(){
        ...
        var bullet = Bullet(this.x,this.y).addChildTo(BulletGroup);
    ...
    OuhukuMove: function(){
        this.x += this.vx;
/*
        if(this.x > SCREEN_WIDTH - this.width || this.x - this.width < 0){
            this.vx *= -1;
          //  this.y += (this.height - 10);
        }
*/
